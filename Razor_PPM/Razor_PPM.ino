/***************************************************************************************************************
* Razor AHRS Firmware v1.4.1 w/ Glove Controller mod
...
#if 0
#define MAGN_X_MIN ((float) -426)
#define MAGN_X_MAX ((float) 554)
#define MAGN_Y_MIN ((float) -435)
#define MAGN_Y_MAX ((float) 608)
#define MAGN_Z_MIN ((float) -505)
#define MAGN_Z_MAX ((float) 499)
#endif

// Magnetometer (extended calibration)
// Uncommend to use extended magnetometer calibration (compensates hard & soft iron errors)
#define CALIBRATION__MAGN_USE_EXTENDED true
const float magn_ellipsoid_center[3] = {72.7281, 68.0290, 11.0699};
const float magn_ellipsoid_transform[3][3] = {{0.965604, 0.00347289, -0.00160427}, {0.00347289, 0.964566, 0.0266881}, {-0.00160427, 0.0266881, 0.979869}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -3.35)
#define GYRO_AVERAGE_OFFSET_Y ((float) -2.00)
#define GYRO_AVERAGE_OFFSET_Z ((float) -13.29)
